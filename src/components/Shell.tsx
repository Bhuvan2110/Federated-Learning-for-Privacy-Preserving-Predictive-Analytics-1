      ...
      {NAV.map((g) => (
        <div key={g.group} className="mb-5">
          ...
          {g.items.map((item) => (
            ...
            >
              <span className={cn("transition-colors", page === item.id ? "text-signal-400" : "text-fog-500 group-hover:text-fog-300")}>
  ...
  return (
    <div className="min-h-screen grid-bg">
      ...
      <div className="lg:pl-[232px] relative">
        ...
        <main className="px-4 sm:px-6 py-5 max-w-[1440px] mx-auto" key={page}>
          {pageEl}
        </main>
